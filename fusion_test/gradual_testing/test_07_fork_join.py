#!/usr/bin/env python3
"""
Test 7: Fork-Join Pattern
One source splits into two parallel computations that both feed into one sink.
A -> B, A -> C, then B+C -> D
Expected: Complex dependency pattern tests fusion strategies.
"""
