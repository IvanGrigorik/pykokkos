#!/usr/bin/env python3
"""
Test 5: Three-Level Chain
A -> B -> C dependency chain
Expected: Vertical/Barrier fuse into 1, Horizontal creates 3 kernels.
"""
...
@pk.workunit
def compute_C(i: int, B: pk.View1D[float], C: pk.View1D[float]):
    C[i] = B[i] + 10.0
